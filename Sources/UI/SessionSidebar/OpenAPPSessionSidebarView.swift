//
//  OpenAPPSessionSidebarView.swift
//  OpenAPPUI
//
...
/// 覆盖 OpenAPPViewController 的 Session 侧栏容器，管理半宽布局、背景点击和可中断进出场动画。
final class OpenAPPSessionSidebarView: UIView {
    var onDismissRequested: (() -> Void)?
    var onSelectItem: ((OpenAPPSessionSidebarItem) -> Void)?

    private(set) var isPresented = false
    let sessionListView = OpenAPPSessionListView()
